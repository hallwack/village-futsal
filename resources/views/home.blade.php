...
<body class="flex flex-col min-h-screen h-full items-center justify-start">
    <nav class="w-full border-b-2 border-b-slate-200">
        <div class="flex flex-row container mx-auto items-center justify-between py-8">
            ...
            <div class="flex flex-row items-center space-x-8">
                ...
                <a class="font-semibold text-lg py-3 px-6 rounded-lg border-2 border-slate-500/70 text-slate-500">Masuk</a>
    ...
    <div class="flex flex-row w-full items-center justify-center container mx-auto my-32">
        <div class="w-1/2 flex flex-col space-y-8">
            <p class="font-bold text-primary text-5xl w-[500px] leading-relaxed">Booking Lapangan Futsal dengan <span class="text-secondary">Cepat</span> dan <span class="text-secondary">Mudah</span></p>
            ...
            <form class="flex flex-row items-center justify-center border p-4 w-fit space-x-8 rounded-lg">
                ...
                <button class="flex flex-row font-semibold text-xl bg-secondary rounded-lg py-3 px-6 h-fit text-white items-center justify-center"><span class="inline-block items-center mr-3"><img src="{{ asset('img/icon/search-icon.svg') }}" /></span>Cari</button>
            </form>
        </div>
    ...
    <div class="container mx-auto flex flex-row w-full h-full items-center justify-center py-24">
        ...
        <div class="w-1/2 flex flex-col space-y-8">
            ...
            <p class="text-slate-800">
                Kami adalah tempat penyewaan lapangan futsal yang berada di Kota Bandung. Kami menggunakan rumput sintetis impor yang kualitasnya tidak perlu diragukan lagi. Kami telah dipercaya oleh banyak orang sebagai salah satu tempat penyewaan lapangan futsal terbaik di Kota Bandung.
            </p>
            <div class="flex flex-row h-full space-x-8">
                ...
                <div class="flex flex-col space-y-2">
                    ...
                    <div class="flex flex-row space-x-2 items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 fill-primary" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 fill-primary/60" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                        </svg>
                    </div>
                </div>
    ...
    <div class="w-full bg-primary/5 border-t-2 border-t-slate-200">
        <div class="flex flex-row container mx-auto items-start justify-between py-12 text-primary">
            ...
            <div class="flex flex-col basis-1/4">
                ...
                <p class="inline-flex items-center mb-1"><span class="mr-4"><img src="{{ asset('img/icon/phone-icon.svg') }}" /></span>081278780940</p>
                <p class="inline-flex items-center mb-1"><span class="mr-4"><img src="{{ asset('img/icon/whatsapp-icon.svg') }}" /></span>081278780940</p>
            </div>
            <div class="flex flex-col basis-1/4">
