...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
            ...
            <!--end::Separator-->
            {{ Breadcrumbs::view('admin.partials.breadcrumbs', 'user-admin') }}
            </h1>
            <!--end::Title-->
        </div>
        <!--end::Page title-->
            ...
            <div class="col-xxl-12">
                <div class="card shadow-sm">
                    <div class="card-header">
                        <h3 class="card-title fs-2 fw-bolder">User</h3>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a data-bs-toggle="modal" data-bs-target="#kt_modal_1"
                                            data-route="{{ route('admin.user.destroy', $item->id) }}"
                                            data-name="{{ $item->user_name }}" id="btn-delete"
