    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ (request()->is('admin/category*')) ? 'active' : '' }}" href="{{ url('admin/category') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-primary svg-icon-2">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ (request()->is('admin/voucher*')) ? 'active' : '' }}" href="{{ url('admin/voucher') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-primary svg-icon-2">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ (request()->is('admin/nominal*')) ? 'active' : '' }}" href="{{ url('admin/nominal') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-primary svg-icon-2">
                                <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Shopping/Sale2.svg-->
                                <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <g id="Stockholm-icons-/-Shopping-/-Price-#1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
