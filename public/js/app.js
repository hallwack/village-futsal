...
__webpack_require__(/*! ./booking-check */ "./resources/js/booking-check.js");

/***/ }),

/***/ "./resources/js/booking-check.js":
/*!***************************************!*\
  !*** ./resources/js/booking-check.js ***!
  \***************************************/
...
const _tmpl$ = /*#__PURE__*/(0,solid_js_web__WEBPACK_IMPORTED_MODULE_0__.template)(`<div>OOHHH GOD IS WORK!!!</div>`, 2);
...
var form = document.getElementById("bookingCheck");
form.addEventListener("submit", function (e) {
  e.preventDefault();
  var formData = new FormData(form);
  axios.post("/booking-check", formData, {
    headers: {
    ...
    var _res$data = res.data,
        data = _res$data.data,
        timePart = _res$data.timePart,
        getDate = _res$data.getDate,
        hourNow = _res$data.hourNow,
        timeNow = _res$data.timeNow;
    console.log(timePart);
    Object.keys(timePart).forEach(function (value) {
      console.log(value);
    });
  })["catch"](function (err) {
    alert(err);
...
(0,solid_js_web__WEBPACK_IMPORTED_MODULE_0__.render)(bookForm, document.getElementById("check-solid"));
